...
const char* ID_MQTT = "esp32_moto_55233";
const char* ID_SENSOR = "02122";
const char* ID_MOTO = "55233";
const char* SETOR_INICIAL = "Danos Estruturais";
// -------------------------------------
...
void publishStatus() {
    ...
    doc["estado"] = "Parada";     char buffer[TAMANHO];
